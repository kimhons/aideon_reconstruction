/**
 * @fileoverview Mock UIContextSchemas for testing.
 * 
 * This module provides mock implementations of UI context schemas
...
function validateContextSchema(data, schema) {
  ...
  // For testing purposes, we'll do minimal validation
  return result;
}
